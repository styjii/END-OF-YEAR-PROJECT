window.addEventListener("load", function () {
  ...
  // ----------------------------- submit ------------------------------
  document
    .querySelector("#help > .form-control")
    .addEventListener("submit", function (event) {
      ...
      spans.forEach((span) => {
        if (
          ...
          document.querySelector("#help textarea").value === ""
        ) {
  ...
  document
    .querySelector(".sing-in")
    .addEventListener("submit", function (event) {
      const spans = [
        ...document.querySelectorAll(".sing-in input + span > .bi"),
      ];
  ...
  document
    ...
    .addEventListener("submit", function (event) {
      const spans = [
        ...document.querySelectorAll(".sing-up input + span > .bi"),
      ];
  ...
  document
    ...
    .addEventListener("submit", function (event) {
      const spans = [
        ...document.querySelectorAll("#reset-password input + span > .bi"),
      ];
