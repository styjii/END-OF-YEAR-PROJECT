<section id="help">
  ...
  <p>
    This website is specializing for people who wants to sell Laptop, Android,
    Iphone, ... <br />
  </p>

  <p>
    If you have a problem when connecting, you can inform me directly below or
    <a href="page/about.php">click here</a> to see the about of page <br />
  </p>
