<form action="./src/include_page/userdata.php" method="post" id="reset-password">
  ...
  <fieldset>
    ...
    <input type="email" value="<?= $youremail?>" name="youremail" id="your-email" placeholder="Email">
    <span><i class="bi bi-x"></i></span>
  </fieldset>
  <fieldset class="password">
    <label for="your-password"><i class="bi bi-lock-fill"></i></label>
    <input type="password" value="<?= $yourpassword?>" name="yourpassword" id="your-password" placeholder="Password">
    <span><i class="bi bi-x"></i></span>
    <span><i class="bi bi-eye-fill"></i></span>
  </fieldset>
  <fieldset class="password">
    <label for="confirm-your-password"><i class="bi bi-lock-fill"></i></label>
    <input type="password" value="<?= $confirmyourpassword?>" name="confirmyourpassword" id="confirm-your-password" placeholder="Confirm Password">
    <span><i class="bi bi-x"></i></span>
    <span><i class="bi bi-eye-fill"></i></span>
  </fieldset>
